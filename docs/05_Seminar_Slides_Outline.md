...
|---|---|---|---|
| Pitch | 0:00 – 0:10 (10 min) | S1 – S5 | Phạm Ngọc Gia Bảo |
| Live demo | 0:10 – 0:20 (10 min) | S6 – S8 (mostly screen-share) | Lee Kun Da + Nguyễn Bình An |
| Audience activity | 0:20 – 0:40 (20 min) | S9 – S12 | Nguyễn Bình An facilitates |
| Q&A | 0:40 – 0:45 (5 min) | S13 – S15 | All; lead = Nguyễn Bình An |
...
- **Owner**: Kun Da demoes; Gia Bảo narrates
...
- **Owner**: Bình An demoes; Gia Bảo narrates
...
- **Content**: 3 bullets distilled from [`03_User_Guide.md`](03_User_Guide.md) §6:
  - <!-- TODO @QuốcBảo: one-liner for each of: Maze success-rate over-confidence; Claude hallucinated UI; AI severity miscalibration. -->
...
## Slide design rules (enforced by Quốc Bảo)
...
<!-- TODO @QuốcBảo: schedule rehearsal time once seminar date is set; add to README §3 Stage Status. -->

---

*Last updated: 2026-06-05 · Skeleton v0.1.0 · Owner: Lưu Ngô Quốc Bảo*
